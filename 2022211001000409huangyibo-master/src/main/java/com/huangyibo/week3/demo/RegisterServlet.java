package com.Huangyibo.week3.demo;
...
public class RegisterServlet<set, OrderList> extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // String id1="1";
        // String username1 = "Huangyibo";
        // String password1 = "2022211001000409";
        ...
        // usertable(id,username,password,email,gender,birthdate) values(?,?,?,?,?,?)");
        ...
        try {
            ...
            try {
                ...
                writer.println(
                        "<tr><th>ID</th><th>Username</th><th>Password</th><th>Email</th><th>Gender</th><th>Birthdate</th></tr>");
                while (rs.next()) {
